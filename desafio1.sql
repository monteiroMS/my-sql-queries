...
CREATE TABLE SpotifyClone.plans(
	plan_id TINYINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE SpotifyClone.musics(
	music_id BIGINT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE SpotifyClone.reprodution_history(
  ...
  reprodution_date DATETIME NOT NULL DEFAULT now(),
  FOREIGN KEY (user_id) REFERENCES users (user_id),
  FOREIGN KEY (music_id) REFERENCES musics (music_id),
  CONSTRAINT PRIMARY KEY(music_id, reprodution_date)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.musics (name, duration_seconds, album_id)
VALUES
  ('Soul For Us', 200, 1),
  ...
  INSERT INTO SpotifyClone.reprodution_history (user_id, music_id, reprodution_date)
VALUES
